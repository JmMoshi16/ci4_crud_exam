...
class Filters extends BaseFilters
{
    ...
    public array $globals = [
        'before' => [
            ...
            'isLoggedIn' => ['except' => ['/', 'register', 'login', 'unauthorized', 'api', 'api/*']],
            'isGranted'  => ['except' => ['/', 'register', 'login', 'logout', 'blocked', 'unauthorized', 'dashboard', 'dashboard-v2', 'dashboard-v3', 'student/*', 'students', 'student', 'profile', 'profile/*', 'admin/*', 'api', 'api/*']],
            // 'honeypot',
            // 'csrf',
            // 'invalidchars',
        ],
